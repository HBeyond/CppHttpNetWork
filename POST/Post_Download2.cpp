...
// 保存URL文件内容到文件
bool url2file(const char* web_url, std::string& savefile) {
    CURL* curl_handle;
    ...
    // set the proxy
    curl_easy_setopt(curl_handle, CURLOPT_PROXY, "10.69.60.221:8080");
    curl_easy_setopt(curl_handle, CURLOPT_PROXYUSERPWD, "binyang.hu:deliveryHBY432");
...
int main(int argc, char* argv[]) {
    const char* url = "http://img04.tooopen.com/images/20131202/sy_49706261893.jpg";
    std::string savePath = "/home/beyoung/Desktop/libcurlDownload.jpg";
    url2file(url, savePath);
    return 1;
}
